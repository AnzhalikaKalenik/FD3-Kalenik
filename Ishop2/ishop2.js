var Ishop2 = React.createClass ({
    ...
    getInitialState: function (){  //магазин должен знать какой товар выделен
      return{
        selectedItemCode: this.props.newSelectedItemCode,
    ...
    render: function (){ // и выглядит компонент вот так 
      var startItemsListCode=this.props.startItemsList.map( v =>
        React.createElement(Item, {key:v.code, product:v.product, price:v.price, photo:v.photo, balance:v.balance, control:v.control })
      );
